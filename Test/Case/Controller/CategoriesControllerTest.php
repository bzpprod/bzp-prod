 ...
 * @var array
 */
	public $fixtures = array('app.category', 'app.product', 'app.user', 'app.group', 'app.qualification', 'app.transaction', 'app.store', 'app.fb_album', 'app.fb_fanpage', 'app.stores_product', 'app.buyer', 'app.qualified_user');
