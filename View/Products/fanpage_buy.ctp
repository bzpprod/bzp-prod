...
<fieldset>
	...
	<div class="buy-product-btnactions">
		...
		<?php if ($hasPaypal):?>
			<a href="javascript:void(1)" onClick="$('#ProductFanpageBuyForm').attr('action','?action=ppPay').attr('target','_blank');$('#ProductFanpageBuyForm').submit();"><img src="<?php echo Configure::read('staticUrl')?>/img/btn_paynowCC_LG.gif" alt="Pagar com PayPal" align="right" style="margin-right:80px" boerder="0"></a>
		<?php else:?>
