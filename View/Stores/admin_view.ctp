<?php
	...
	$this->set('body_page', 'mystore_view');
...
<div id="store-view-mode">
                ...
                <div class='buttonWrapper left'>
    	    		<a class="spriteButton type3 button" href="<?php echo Router::url(array('controller' => 'stores', 'action' => 'view_archive', 'admin' => true, 'store' => $store['Store']['slug']))?>" rel="nofollow">
