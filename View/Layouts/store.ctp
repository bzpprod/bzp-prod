...
<head prefix="og: http://ogp.me/ns# [<?php echo Configure::read('Facebook.Namespace'); ?>]: 
	...
	<?php
		...
		echo $this->Html->script('third/jquery.cookies.2.2.0.min.js');
...
<body lang="br">
	<div id="global" class="store <?php print !empty($body_class) ? $body_class : ''; ?> <?php print !empty($body_page) ? $body_page : ''; ?>" >
