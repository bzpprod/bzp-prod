...
class FacebookHelper extends AppHelper {
	...
	*/
	...
	window.fbAsyncInit = function() {
		...
		if (typeof window.facebook_started == 'function') facebook_started();
		
		
		// Checks whether the user is logged in
		FB.getLoginStatus(function(response) {
			if (typeof window.facebook_login_status == 'function') facebook_login_status(response);
		...
		FB.Event.subscribe('edge.create',
			function(response)
			{
				if (typeof window.facebook_edge_create == 'function') facebook_edge_create(response);
			}
		);
		...
		FB.Event.subscribe('edge.remove',
			function(response)
			{
				if (typeof window.facebook_edge_remove == 'function') facebook_edge_remove(response);
			}
		);
		...
		FB.Event.subscribe('comment.create',
			function(response)
			{
				if (typeof window.facebook_comment_create == 'function') facebook_comment_create(response);
			}
		);
