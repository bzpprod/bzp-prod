 ...
 */
	function beforeSave(&$model) {
		$model->data[$model->alias]['hash'] = String::uuid();
 ...
 */
	function _createThumbnails(&$model, $data, $fieldName, $saveAs, $ext, $options) {
		...
		foreach ($options['thumbsizes'] as $key => $value) {
			...
			if (isset($value['fixedAspectRatio'])) {
				$params['fixedAspectRatio'] = $value['fixedAspectRatio'];
			}
			if (isset($value['backgroungColor'])) {
				$params['backgroungColor'] = $value['backgroungColor'];
			}
 ...
 */
	function _createThumbnail(&$model, $source, $target, $fieldName, $params = array()) {
		...
		$phpThumb->setParameter('far', $this->__fields[$model->alias][$fieldName]['fixedAspectRatio']);
		$phpThumb->setParameter('bgcolor', $this->__fields[$model->alias][$fieldName]['backgroungColor']);
		
		if (isset($params['zoomCrop'])){
			$phpThumb->setParameter('zc', $params['zoomCrop']);
		}
		if (isset($params['fixedAspectRatio'])){
			$phpThumb->setParameter('far', $params['fixedAspectRatio']);
		}
		if (isset($params['backgroungColor'])){
			$phpThumb->setParameter('bgcolor', $params['backgroungColor']);
		}
